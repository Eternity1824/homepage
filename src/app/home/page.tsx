...
export default function Home() {
  return (
    <main className="py-28 bg-background text-foreground">
      ...
      <div className="mt-8 flex gap-3">
        ...
        <a href="https://github.com/..." target="_blank" rel="noopener noreferrer"
           className="rounded-xl border border-foreground/20 px-4 py-2">GitHub</a>
        <a href="/Resume.pdf" className="rounded-xl border border-foreground/20 px-4 py-2">Resume</a>
      </div>
    </main>
  );
}
